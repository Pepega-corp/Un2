namespace Unicon2.Fragments.Measuring.Infrastructure.Keys
{
   public static class MeasuringKeys
   {
       public const string FAST_READING_RANGE_SETTING = "FastReadingRangeSetting";
       public const string MEASURING_MONITOR = "MeasuringMonitor";
       public const string MEASURING_GROUP = "MeasuringGroup";
       public const string BIT_ADDRESS = "BitAddress";
