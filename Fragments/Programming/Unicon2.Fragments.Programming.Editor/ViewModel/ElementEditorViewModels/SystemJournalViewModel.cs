...
{
    public class SystemJournalViewModel : ViewModelBase, ILogicElementEditorViewModel
    {
        private IJournalEditor _model;
        private EditableListItem _selectedOutputSignal;
        
        public string ElementName => "Системный журнал";
        public string Symbol => "ЖС";
        public string Description => "Выходной логический сигнал Журнал Системы";

        public string StrongName => ProgrammingKeys.SYSTEM_JOURNAL + ApplicationGlobalNames.CommonInjectionStrings.EDITOR_VIEWMODEL;
        ...
        public SystemJournalViewModel(SystemJournalEditor model)
        {
        ...
        public object Clone()
        {
            return new SystemJournalViewModel(new SystemJournalEditor());
        }
    }
}