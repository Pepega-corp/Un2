...
namespace Unicon2.Fragments.Programming.Editor.Models.LibraryElements
{
    ...
    public class SystemJournalEditor : IJournalEditor
    {
        ...
        public string StrongName => ProgrammingKeys.SYSTEM_JOURNAL + ApplicationGlobalNames.CommonInjectionStrings.EDITOR;
        public ElementType ElementType => ElementType.JS;
