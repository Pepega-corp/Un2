...
{
	public class ValueViewModelFactory : IValueVisitor<IFormattedValueViewModel>
	{
		[CanBeNull] private IRangeable _rangeable;
		[CanBeNull] private IMeasurable _measurable;

		public ValueViewModelFactory([CanBeNull] IRangeable rangeable = null, [CanBeNull] IMeasurable measurable = null)
		{
