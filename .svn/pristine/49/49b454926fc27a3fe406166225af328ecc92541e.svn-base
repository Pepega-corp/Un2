...
namespace NModbus4.UnitTests.Message
{
    public class ReadCoilsInputsRequestFixture
    {
        ...
        public void ToString_ReadCoilsRequest()
        {
            ...
            Assert.Equal((string) "Read 10 coils starting at address 1.", (string) request.ToString());
        }
        ...
        public void ToString_ReadInputsRequest()
        {
            ...
            Assert.Equal((string) "Read 10 inputs starting at address 1.", (string) request.ToString());
        }
    }
}