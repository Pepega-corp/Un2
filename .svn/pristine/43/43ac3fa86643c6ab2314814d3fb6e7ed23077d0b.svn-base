...
namespace NModbus4.UnitTests.Message
{
    public class WriteSingleCoilRequestResponseFixture
    {
        ...
        public void ToString_True()
        {
            ...
            Assert.Equal((string) "Write single coil 1 at address 5.", (string) request.ToString());
        }
        ...
        public void ToString_False()
        {
            ...
            Assert.Equal((string) "Write single coil 0 at address 5.", (string) request.ToString());
        }
    }
}