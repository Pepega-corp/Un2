...
namespace Unicon2.Formatting.Module
{
    public class FormattingModule : IUnityModule
    {
        ...
        {
            container.Register(typeof(IUshortsFormatter), typeof(AsciiStringFormatter), StringKeys.ASCII_STRING_FORMATTER);
            container.Register(typeof(IUshortsFormatter), typeof(DictionaryMatchingFormatter), StringKeys.DICTIONARY_MATCHING_FORMATTER);
            container.Register(typeof(IUshortsFormatter), typeof(FormulaFormatter), StringKeys.FORMULA_FORMATTER);
            container.Register(typeof(IUshortsFormatter), typeof(DirectUshortFormatter), StringKeys.DIRECT_USHORT_FORMATTER);
            container.Register(typeof(IUshortsFormatter), typeof(BoolFormatter), StringKeys.BOOL_FORMATTER);
            container.Register(typeof(IUshortsFormatter), typeof(DefaultTimeFormatter), StringKeys.DEFAULT_TIME_FORMATTER);
            container.Register(typeof(IUshortsFormatter), typeof(UshortToIntegerFormatter), StringKeys.USHORT_TO_INTEGER_FORMATTER);
            container.Register(typeof(IUshortsFormatter), typeof(DefaultBitMaskFormatter), StringKeys.DEFAULT_BIT_MASK_FORMATTER);
