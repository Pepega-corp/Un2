...
//using FreeLogicProgrammMVVM.Models;
//using FreeLogicProgrammMVVM.ViewModels;

//namespace FreeLogicProgrammMVVM
//{
...
//        internal static List<Point> GetConnectionLine(ConnectorViewModel source, ConnectorViewModel sink)
//        {
...
//        private static void AddOtherPoints(List<Point> linePoints, ConnectorViewModel source, ConnectorViewModel sink, Rect sourceRect, Rect sinkRect)
//        {
...
//        /// </summary>
//        private static void AddLineAround(List<Point> linePoints, ConnectorViewModel source, ConnectorViewModel sink, Rect sourceRect, Rect sinkRect)
//        {
...
//        internal static List<Point> GetConnectionLine(ConnectorViewModel source, Point sinkPoint, ConnectorOrientation preferredOrientation)
//        {
//            List<Point> linePoints = new List<Point>();
//            Rect sourceRect = GetElementRect(source);
...
//        private static void AddOtherPoints(List<Point> linePoints, ConnectorViewModel source, Point sinkPoint, Rect sourceRect)
//        {
...
//        private static void OptimizeLine(List<Point> linePoints, ConnectorViewModel source, ConnectorViewModel sink, Rect sourceRect, Rect sinkRect)
//        {
...
//        private static bool IsPointVisible(ConnectorViewModel source, Point sinkPoint, Rect sourceRect)
//        {
...
//        /// <returns></returns>
//        private static bool TargetIsNotVisible(Rect sourceRect, Rect sinkRect, ConnectorViewModel sink)
//        {
...
//        private static Point GetNearestNeighborSource(ConnectorViewModel source, Point endPoint, Rect rectSource)
//        {
...
//        private static Point GetNearestNeighborSink(ConnectorViewModel sink, Rect sinkRect, Point sourcePoint)
//        {
//            Point n1, n2; // точки углов рамки
...
//        private static Rect GetElementRect(ConnectorViewModel source)
//        {
//            Rect rect = new Rect(source.ParentViewModel.X, source.ParentViewModel.Y, source.ParentViewModel.Width, source.ParentViewModel.Height);
