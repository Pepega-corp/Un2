...
namespace NModbus4.UnitTests.Message
{
    public class ReadHoldingInputRegistersRequestFixture
    {
        ...
        public void ToString_ReadHoldingRegistersRequest()
        {
            ...
            Assert.Equal((string) "Read 10 holding registers starting at address 1.", (string) request.ToString());
        }
        ...
        public void ToString_ReadInputRegistersRequest()
        {
            ...
            Assert.Equal((string) "Read 10 input registers starting at address 1.", (string) request.ToString());
        }
    }
}