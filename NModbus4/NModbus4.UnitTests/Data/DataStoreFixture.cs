    ...
    public class DataStoreFixture
    {
        ...
        public void ReadData()
        {
            ...
            RegisterCollection result = DataStore.ReadData<RegisterCollection, ushort>(new DataStore(), slaveCol, 1, 3,
                new object());
            Assert.Equal(new ushort[] { 1, 2, 3 }, Enumerable.ToArray<ushort>(result));
        }

        [Fact]
        public void ReadDataStartAddressTooLarge()
        {
            Assert.Throws<InvalidModbusRequestException>((Func<object>) (() =>
        ...
        {
            Assert.Throws<InvalidModbusRequestException>((Func<object>) (() => DataStore.ReadData<DiscreteCollection, bool>(new DataStore(),
        ...
        public void WriteDataMultiple()
        {
            ...
            DataStore.WriteData(new DataStore(), newValues, destination, 0, new object());
            Assert.Equal(new bool[] { false, true, true, true, true, false, false, true }, Enumerable.ToArray<bool>(destination));
        }
        ...
        public void WriteDataTooLarge()
        {
            ...
            Assert.Throws<InvalidModbusRequestException>((Action) (() => DataStore.WriteData(new DataStore(), newValues, slaveCol, 1, new object())));
        }
        ...
        {
            Assert.Throws<InvalidModbusRequestException>((Action) (() => DataStore.WriteData(new DataStore(), new DiscreteCollection(true), new ModbusDataCollection<bool>(true), 2,
                new object())));
        }
        ...
        public void DataStoreReadFromEvent_ReadHoldingRegisters()
        {
            ...
            dataStore.DataStoreReadFrom += (obj, e) =>
            {
                ...
                Assert.Equal(new ushort[] { 4, 5, 6 }, Enumerable.ToArray<ushort>(e.Data.B));
        ...
        public void DataStoreReadFromEvent_ReadInputRegisters()
        {
            ...
            dataStore.DataStoreReadFrom += (obj, e) =>
            {
                ...
                Assert.Equal(new ushort[] { }, Enumerable.ToArray<ushort>(e.Data.B));
        ...
        public void DataStoreReadFromEvent_ReadInputs()
        {
            ...
            dataStore.DataStoreReadFrom += (obj, e) =>
            {
                readFromEventFired = true;
                Assert.Equal(4, e.StartAddress);
                Assert.Equal(new bool[] { false }, Enumerable.ToArray<bool>(e.Data.A));
        ...
        public void DataStoreWrittenToEvent_WriteCoils()
        {
            ...
            dataStore.DataStoreWrittenTo += (obj, e) =>
            {
                ...
                Assert.Equal(4, e.StartAddress);
                Assert.Equal(new[] { true, false, true }, Enumerable.ToArray<bool>(e.Data.A));
        ...
        public void DataStoreWrittenToEvent_WriteHoldingRegisters()
        {
            ...
            dataStore.DataStoreWrittenTo += (obj, e) =>
            {
                ...
                Assert.Equal(new ushort[] { 5, 6, 7 }, Enumerable.ToArray<ushort>(e.Data.B));
                Assert.Equal(ModbusDataType.HoldingRegister, e.ModbusDataType);
            };
        ...
        public void UpdateItemsTooLarge()
        {
            ...
            Assert.Throws<InvalidModbusRequestException>((Action) (() => DataStore.Update<int>(newItems, destination, 3)));
        }
        ...
        public void UpdateNegativeIndex()
        {
            List<int> newItems = new List<int>(new int[] { 1, 2, 3, 7, 8, 9 });
            List<int> destination = new List<int>(new int[] { 4, 5, 6 });
            Assert.Throws<InvalidModbusRequestException>((Action) (() => DataStore.Update<int>(newItems, destination, -1)));
        }
    }
}