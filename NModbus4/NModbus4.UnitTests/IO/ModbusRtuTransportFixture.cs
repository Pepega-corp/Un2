...
namespace NModbus4.UnitTests.IO
{
    public class ModbusRtuTransportFixture
    {
        ...
        public void ChecksumsMatchSucceed()
        {
            ...
            Assert.True((bool) transport.ChecksumsMatch(message, frame));
        }
        ...
        public void ReadRequest()
        {
            ...
            Assert.Equal<byte[]>(new byte[] { 1, 1, 1, 0, 1, 0, 0, 5 }, transport.ReadRequest());
        ...
        public void Read()
        {
            ...
            Assert.Equal<byte[]>(new byte[] { 2, 2, 2, 3, 3 }, transport.Read(5));
